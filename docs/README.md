...
| Inspect the current public generic-callback every-bar/sparse performance evidence and its limits | [NEXT-01 reactive runtime closure](performance/next01_reactive_public_runtime.md) |
