...
def test_phase42c_ci_uses_uv_matrix_and_installed_package_smoke() -> None:
    ...
    assert "--ignore=tests/test_phase47a_grid_adapter.py" in workflow_text
    assert "--ignore=tests/test_phase47c_grid_parity.py" in workflow_text
    assert "--ignore=tests/test_phase47d_grid_optimizer.py" in workflow_text
