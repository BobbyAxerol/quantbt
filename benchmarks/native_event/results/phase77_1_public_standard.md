...
|---|---|---:|---:|---|
| `mode1_global_w0_native_eligible` | prepared-native / `native_prepared` | 0.385958 s vs 0.775200 s reference | 24 | one retrospective study; declared fold OOS participates in decay selection |
