...
ROUTE_ROWS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "optimization_target": "AP-07/AP-08 run-local evaluation graph and streaming retention verified by PERF-05",
    ...
    },
    {
        ...
        "optimization_target": "AP-08 streaming replicate-vector retention verified by PERF-05; no hidden top-K reduction",
    ...
    },
    {
        ...
        "optimization_target": "AP-07/AP-08 evaluation identity and plateau retention verified by PERF-05",
        "oracle_tests": ("tests/test_walkforward_phase1.py",),
        "benchmark_fixture": "phase77.1 required mode schedule matrix",
        "anchors": ("src/quantbt/endpoint.py", "src/quantbt/walkforward.py"),
    },
    {
        ...
        "optimization_target": "AP-07/AP-08 exact prepared-native score reuse and IS-only retention verified by PERF-05",
    ...
    },
    {
        ...
        "optimization_target": "AP-07 full-IS execution/analysis identity verified by PERF-05",
        "oracle_tests": ("tests/test_walkforward_phase1.py",),
        "benchmark_fixture": "phase77.1 required mode schedule matrix",
        "anchors": ("src/quantbt/endpoint.py", "src/quantbt/walkforward.py"),
    },
...
AP_DISPOSITIONS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "owner": "PERF-05",
        "evidence": (
            "src/quantbt/core/wfo_evaluation.py",
            "src/quantbt/walkforward.py",
            "tests/test_perf_05_wfo_evaluation_reuse.py",
            "docs/performance/perf_05_wfo_evaluation_reuse.md",
        ),
    },
    {
        "id": "AP-08",
    ...
    },
    {
        ...
        "owner": "PERF-06",
        "evidence": (
            "src/quantbt/core/research_audit.py",
            "src/quantbt/core/research_audit_artifact.py",
            "src/quantbt/walkforward.py",
            ...
            "docs/performance/perf_06_research_audit.md",
        ),
    },
...
def build_manifest() -> dict[str, Any]:
    ...
    covered = {
        ...
        38: ("PERF-06", "tests/test_perf_06_research_audit.py::test_perf06_full_trial_ledger_keeps_full_fold_metrics_while_public_table_stays_compact"),
        39: ("PERF-06", "tests/test_perf_06_research_audit.py::test_perf06_columnar_codec_is_immutable_exact_and_never_uses_repr_identity"),
